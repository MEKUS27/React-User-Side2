...
const Header = () => {
  return (
    <>
      ...
      <header className='header-upper py-3 px-5'>
        <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h2>
                <Link to='/' className='text-white'>E-Store</Link>
              </h2>
            </div>
            <div className='col-5'>
              <div className="input-group">
                <input type="text" className="form-control py-2 pe-5" placeholder="Search Product Here..." aria-label="Search Product Here..." aria-describedby="basic-addon2" />
      ...
      <header className='header-bottom py-3 px-5'>
        <div className='container-xxl'>
          <div className='row'>
